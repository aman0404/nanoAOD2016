...
enum class CUTS {
  eGen,
    eGTau,        eGTop,        eGElec,       eGMuon,       eGZ,        eGW,       eGHiggs, eGJet, eGBJet,
  ...
  eMuon1Jet1,   eMuon1Jet2,   eMuon2Jet1,   eMuon2Jet2,
...
static std::unordered_map<CUTS, std::string, EnumHash> enumNames {
  ...
  {CUTS::eMuon1Jet1, "eMuon1Jet1"}, {CUTS::eMuon1Jet2, "eMuon1Jet2"}, {CUTS::eMuon2Jet1, "eMuon2Jet1"},   {CUTS::eMuon2Jet2, "eMuon2Jet2"},
