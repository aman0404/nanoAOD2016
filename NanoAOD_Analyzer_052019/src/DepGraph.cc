...
//Aman
  ...
  add_edge(cutint(CUTS::eMuon1Jet1), cutint(CUTS::eRMuon1), g);
  add_edge(cutint(CUTS::eMuon1Jet1), cutint(CUTS::eRJet1), g);
  add_edge(cutint(CUTS::eMuon1Jet2), cutint(CUTS::eRMuon1), g);
  add_edge(cutint(CUTS::eMuon1Jet2), cutint(CUTS::eRJet2), g);
  add_edge(cutint(CUTS::eMuon2Jet1), cutint(CUTS::eRMuon2), g);
  add_edge(cutint(CUTS::eMuon2Jet1), cutint(CUTS::eRJet1), g);
  add_edge(cutint(CUTS::eMuon2Jet2), cutint(CUTS::eRMuon2), g);
  add_edge(cutint(CUTS::eMuon2Jet2), cutint(CUTS::eRJet2), g);
